    ...
    <li {...props}>
      <div ref={measureRef} className="pb-2">
        <button
          ...
          className={`block text-left w-full border border-slate-200 p-2 lg:p-4 rounded-md hover:cursor-pointer
          ...
          <div className="grid grid-cols-3">
            ...
            <p className="capitalize col-span-2 flex items-center gap-x-2 lg:block">
              {item.type}
              {item.isPickup ? (
